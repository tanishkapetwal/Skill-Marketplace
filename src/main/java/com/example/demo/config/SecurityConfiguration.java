    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http.csrf(csrf->csrf.disable())
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/ws/**","/login", "/customer/signup","/logout", "/seller/signup","/customer/refresh","/seller/reset-password","/customer/reset-password","/admin/reset-password").permitAll()
